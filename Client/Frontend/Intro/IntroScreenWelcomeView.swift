...
class IntroScreenWelcomeView: UIView, CardTheme {
    ...
    private func initialViewSetup() {
        ...
        titleImageViewPage1.snp.makeConstraints { make in
          ...
          make.leading.equalTo(imageHolder.snp.leading).offset(30)
          make.trailing.equalTo(imageHolder.snp.trailing).offset(-30)
        }
        
        main2panel.addArrangedSubview(bottomHolder)
        [titleLabel, subTitleLabelPage1, nextButton].forEach {

...
extension Strings {
    ...
    public static let SettingsDisconnectSyncAlertBody = MZLocalizedString("Settings.Disconnect.Body", value: "OceanHero will stop syncing with your account, but won’t delete any of your browsing data on this device.", comment: "Body of the alert when prompting the user asking to disconnect.")
...
extension Strings {
    ...
    public static let EmptySyncedTabsPanelStateTitle = MZLocalizedString("HistoryPanel.EmptySyncedTabsState.Title", value: "OceanHero Sync", comment: "Title for the empty synced tabs state in the History Panel")
    ...
    public static let FirefoxHomePage = MZLocalizedString("Firefox.HomePage.Title", value: "OceanHero Home Page", comment: "Title for OceanHero about:home page in tab history list")
...
extension Strings {
    ...
    public static let FirefoxSyncCreateAccount = MZLocalizedString("Sync.NoAccount.Description", value: "No account? Create one to sync OceanHero between devices.", comment: "String displayed on Sign In to Sync page that allows the user to create a new account.")
...
extension Strings {
    ...
    public static let BreachAlertsLearnMore = MZLocalizedString("BreachAlerts.LearnMoreButton", value: "Learn more", comment: "Link to monitor.OceanHero.com to learn more about breached passwords")
...
extension Strings {
    // Settings strings
    public static let FxAFirefoxAccount = MZLocalizedString("FxA.FirefoxAccount", value: "OceanHero Account", comment: "Settings section title for OceanHero Account")
    ...
    public static let FxAManageAccount = MZLocalizedString("FxA.ManageAccount", value: "Manage Account & Devices", comment: "Button label to go to OceanHero Account settings")
    public static let FxASyncNow = MZLocalizedString("FxA.SyncNow", value: "Sync Now", comment: "Button label to Sync your OceanHero Account")
    ...
    public static let FxASettingsTitle = MZLocalizedString("Settings.FxA.Title", value: "OceanHero Account", comment: "Title displayed in header of the FxA settings panel.")
    public static let FxASettingsSyncSettings = MZLocalizedString("Settings.FxA.Sync.SectionName", value: "Sync Settings", comment: "Label used as a section title in the OceanHero Accounts Settings screen.")
    ...
    public static let FxARemoveAccountButton = MZLocalizedString("FxA.RemoveAccount", value: "Remove", comment: "Remove button is displayed on OceanHero account page under certain scenarios where user would like to remove their account.")
    public static let FxARemoveAccountAlertTitle = MZLocalizedString("FxA.RemoveAccountAlertTitle", value: "Remove Account", comment: "Remove account alert is the final confirmation before user removes their OceanHero account")
    public static let FxARemoveAccountAlertMessage = MZLocalizedString("FxA.RemoveAccountAlertMessage", value: "Remove the OceanHero Account associated with this device to sign in as a different user.", comment: "Description string for alert view that gets presented when user tries to remove an account.")

    // Surface error strings
    public static let FxAAccountVerificationRequiredSurface = MZLocalizedString("FxA.AccountVerificationRequiredSurface", value: "You need to verify %@. Check your email for the verification link from OceanHero.", comment: "Message explaining that user needs to check email for OceanHero Account verfication link.")
...
extension Strings {
    ...
    public static let SettingsNewTabTopSites = MZLocalizedString("Settings.NewTab.Option.FirefoxHome", value: "OceanHero Home", comment: "Option in settings to show OceanHero Home when you open a new tab")
    ...
    public static let SettingsTopSitesCustomizeTitle = MZLocalizedString("Settings.NewTab.Option.CustomizeTitle", value: "Customize OceanHero Home", comment: "The title for the section to customize top sites in the new tab settings page.")
...
extension Strings {
    ...
    public static let SettingsAdvancedAccountCustomFxAContentServerURI = "Custom OceanHero Account Content Server URI"
...
extension Strings {
    ...
    public static let SettingsOfferClipboardBarStatus = MZLocalizedString("Settings.OfferClipboardBar.Status", value: "When Opening OceanHero", comment: "Description displayed under the ”Offer to Open Copied Link” option. See https://bug1223660.bmoattachments.org/attachment.cgi?id=8898349")
}
...
// MARK: - Errors
extension Strings {
    public static let UnableToDownloadError = MZLocalizedString("Downloads.Error.Message", value: "Downloads aren’t supported in OceanHero yet.", comment: "The message displayed to a user when they try and perform the download of an asset that OceanHero cannot currently handle.")
    ...
    public static let UnableToOpenURLError = MZLocalizedString("OpenURL.Error.Message", value: "OceanHero cannot open the page because it has an invalid address.", comment: "The message displayed to a user when they try to open a URL that cannot be handled by OceanHero, or any external app.")
...
extension Strings {
    public static let PhotoLibraryFirefoxWouldLikeAccessTitle = MZLocalizedString("PhotoLibrary.FirefoxWouldLikeAccessTitle", value: "OceanHero would like to access your Photos", comment: "See http://mzl.la/1G7uHo7")
...
extension Strings {
    // zero tabs
    public static let SentTab_NoTabArrivingNotification_title = MZLocalizedString("SentTab.NoTabArrivingNotification.title", value: "OceanHero Sync", comment: "Title of notification received after a spurious message from FxA has been received.")
...
extension Strings {
    ...
    public static let FxAPush_DeviceDisconnected_ThisDevice_body = MZLocalizedString("FxAPush_DeviceDisconnected_ThisDevice_body", value: "This device has been successfully disconnected from OceanHero Sync.", comment: "Body of a notification displayed when this device has been disconnected from FxA by another device.")
    ...
    public static let FxAPush_DeviceDisconnected_UnknownDevice_body = MZLocalizedString("FxAPush_DeviceDisconnected_UnknownDevice_body", value: "A device has disconnected from OceanHero Sync", comment: "Body of a notification displayed when unnamed device has been disconnected from FxA.")
    ...
    public static let FxAPush_DeviceConnected_body = MZLocalizedString("FxAPush_DeviceConnected_body", value: "OceanHero Sync has connected to %@", comment: "Title of a notification displayed when another device has connected to FxA. %@ refers to the name of the newly connected device.")
}
...
extension Strings {
    ...
    public static let ScanQRCodePermissionErrorMessage = MZLocalizedString("ScanQRCode.PermissionError.Message", value: "Please allow OceanHero to access your device’s camera in ‘Settings’ -> ‘Privacy’ -> ‘Camera’.", comment: "Text of the prompt user to setup the camera authorization.")
...
extension Strings {
    ...
    public static let AppMenuLibrarySeeAllTitleString = MZLocalizedString("Menu.SeeAllAction.Title", tableName: "Menu", value: "See All", comment: "Label for the button, displayed in OceanHero Home, used to see all Library panels.")
...
extension Strings {
    ...
    public static let TrackingProtectionOptionBlockListsHeader = MZLocalizedString("Settings.TrackingProtection.BlockListsHeader", value: "You can choose which list OceanHero will use to block Web elements that may track your browsing activity.", comment: "Header description for tracking protection options section where Basic/Strict block list can be selected")
...
extension Strings {
    public static let TPBlockingDescription = MZLocalizedString("Menu.TrackingProtectionBlocking.Description", value: "OceanHero is blocking parts of the page that may track your browsing.", comment: "Description of the Tracking protection menu when TP is blocking parts of the page")
    ...
    public static let StrictETPWithITP = MZLocalizedString("Menu.EnhancedTrackingProtectionStrictWithITP.Title", value: "OceanHero blocks cross-site trackers, social trackers, cryptominers, fingerprinters, and tracking content.", comment: "Description for having strict ETP protection with ITP offered in iOS14+")
    public static let StandardETPWithITP = MZLocalizedString("Menu.EnhancedTrackingProtectionStandardWithITP.Title", value: "OceanHero blocks cross-site trackers, social trackers, cryptominers, and fingerprinters.", comment: "Description for having standard ETP protection with ITP offered in iOS14+")
    ...
    public static let TPPageMenuNoTrackersBlocked = MZLocalizedString("Menu.TrackingProtection.NoTrackersBlockedTitle", value: "No trackers known to OceanHero were detected on this page.", comment: "Message in menu when no trackers blocked.")
...
extension Strings {
    ...
    public static let SendUsageSettingMessage = MZLocalizedString("Settings.SendUsage.Message", value: "Mozilla strives to only collect what we need to provide and improve OceanHero for everyone.", comment: "A short description that explains why mozilla collects usage data.")
    ...
    public static let SettingsSiriSectionDescription = MZLocalizedString("Settings.Siri.SectionDescription", value: "Use Siri shortcuts to quickly open OceanHero via Siri", comment: "The description that describes what siri shortcuts are")
...
extension Strings {
    ...
    public static let SettingsStudiesToggleMessage = MZLocalizedString("Settings.Studies.Toggle.Message", value: "OceanHero may install and run studies from time to time.", comment: "A short description that explains that Mozilla is running studies")
...
extension Strings {
    // First Card
    public static let CardTitleWelcome = MZLocalizedString("Intro.Slides.Welcome.Title.v2", tableName: "Intro", value: "Welcome to OceanHero", comment: "Title for the first panel 'Welcome' in the First Run tour.")
    ...
    public static let CardTitleSafeSync = MZLocalizedString("Intro.Slides.Safe.Sync.Title", tableName: "Intro", value: "Safe Sync", comment: "Title for the third item in the table related to safe syncing with a OceanHero account")
    public static let CardDescriptionSafeSync = MZLocalizedString("Intro.Slides.Safe.Sync.Description", tableName: "Intro", value: "Protect your logins and data everywhere you use OceanHero.", comment: "Description for the third item in the table related to safe syncing with a OceanHero account")
    
    // Second Card
    public static let CardTitleFxASyncDevices = MZLocalizedString("Intro.Slides.Firefox.Account.Sync.Title", tableName: "Intro", value: "Sync OceanHero Between Devices", comment: "Title for the first item in the table related to syncing data (bookmarks, history) via OceanHero account between devices")
    public static let CardDescriptionFxASyncDevices = MZLocalizedString("Intro.Slides.Firefox.Account.Sync.Description", tableName: "Intro", value: "Bring bookmarks, history, and passwords to OceanHero on this device.", comment: "Description for the first item in the table related to syncing data (bookmarks, history) via OceanHero account between devices")
    ...
    public static let CardTextMail = MZLocalizedString("Intro.Slides.Mail.Description", tableName: "Intro", value: "Use any email app — not just Mail — with OceanHero.", comment: "Description for the 'Mail' panel in the First Run tour.")
    ...
    public static let IntroSignInButtonTitle = MZLocalizedString("Intro.Slides.Button.SignIn", tableName: "Intro", value: "Sign In", comment: "Sign in to OceanHero account button on second intro screen.")
    public static let IntroSignUpButtonTitle = MZLocalizedString("Intro.Slides.Button.SignUp", tableName: "Intro", value: "Sign Up", comment: "Sign up to OceanHero account button on second intro screen.")
}
...
extension Strings {
    ...
    public static let SendToNotSignedInText = MZLocalizedString("SendTo.NotSignedIn.Title", value: "You are not signed in to your OceanHero Account.", comment: "See http://mzl.la/1ISlXnU")
    public static let SendToNotSignedInMessage = MZLocalizedString("SendTo.NotSignedIn.Message", value: "Please open OceanHero, go to Settings and sign in to continue.", comment: "See http://mzl.la/1ISlXnU")
    public static let SendToSignInButton = MZLocalizedString("SendTo.SignIn.Button", value: "Sign In to OceanHero", comment: "The text for the button on the Send to Device page if you are not signed in to OceanHero Accounts.")
    public static let SendToNoDevicesFound = MZLocalizedString("SendTo.NoDevicesFound.Message", value: "You don’t have any other devices connected to this OceanHero Account available to sync.", comment: "Error message shown in the remote tabs panel")
    ...
    public static let ShareAddToReadingList = MZLocalizedString("ShareExtension.AddToReadingListAction.Title", value: "Add to Reading List", comment: "Action label on share extension to add page to the OceanHero reading list.")
    ...
    public static let ShareBookmarkThisPage = MZLocalizedString("ShareExtension.BookmarkThisPageAction.Title", value: "Bookmark This Page", comment: "Action label on share extension to bookmark the page in OceanHero.")
    ...
    public static let ShareOpenInFirefox = MZLocalizedString("ShareExtension.OpenInFirefoxAction.Title", value: "Open in OceanHero", comment: "Action label on share extension to immediately open page in OceanHero.")
    public static let ShareSearchInFirefox = MZLocalizedString("ShareExtension.SeachInFirefoxAction.Title", value: "Search in OceanHero", comment: "Action label on share extension to search for the selected text in OceanHero.")
    public static let ShareOpenInPrivateModeNow = MZLocalizedString("ShareExtension.OpenInPrivateModeAction.Title", value: "Open in Private Mode", comment: "Action label on share extension to immediately open page in OceanHero in private mode.")

    public static let ShareLoadInBackground = MZLocalizedString("ShareExtension.LoadInBackgroundAction.Title", value: "Load in Background", comment: "Action label on share extension to load the page in OceanHero when user switches apps to bring it to foreground.")
    public static let ShareLoadInBackgroundDone = MZLocalizedString("ShareExtension.LoadInBackgroundActionDone.Title", value: "Loading in OceanHero", comment: "Share extension label shown after user has performed 'Load in Background' action.")

}

// MARK: - PasswordAutofill extension
extension Strings {
    public static let PasswordAutofillTitle = MZLocalizedString("PasswordAutoFill.SectionTitle", value: "OceanHero Credentials", comment: "Title of the extension that shows OceanHero passwords")
    public static let CredentialProviderNoCredentialError = MZLocalizedString("PasswordAutoFill.NoPasswordsFoundTitle", value: "You don’t have any credentials synced from your OceanHero Account", comment: "Error message shown in the remote tabs panel")
...
extension Strings {
    ...
    public static let FxASignin_QRInstructions = MZLocalizedString("fxa.signin.qr-link-instruction", value: "On your computer open OceanHero and go to OceanHero.com/pair", comment: "FxA sign in view qr code instructions")
    ...
    public static let FxASignin_CreateAccountPt1 = MZLocalizedString("fxa.signin.create-account-pt-1", value: "Sync OceanHero between devices with an account.", comment: "FxA sign in create account label.")
    public static let FxASignin_CreateAccountPt2 = MZLocalizedString("fxa.signin.create-account-pt-2", value: "Create OceanHero account.", comment: "FxA sign in create account label. This will be linked to the site to create an account.")
}

// MARK: - FxA QR code scanning screen
extension String {
    public static let FxAQRCode_Instructions = MZLocalizedString("fxa.qr-scanning-view.instructions", value: "Scan the QR code shown at OceanHero.com/pair", comment: "Instructions shown on qr code scanning view")
}
...
extension String {
    ...
    public static let QuickActionsGalleryTitlev2 = MZLocalizedString("TodayWidget.QuickActionsGalleryTitleV2", tableName: "Today", value: "OceanHero Shortcuts", comment: "OceanHero shortcuts title when widget enters edit mode. Do not translate the word OceanHero.")
    ...
    public static let QuickActionsSubLabel = MZLocalizedString("TodayWidget.QuickActionsSubLabel", tableName: "Today", value: "OceanHero - Quick Actions", comment: "Sub label for medium size quick action widget")
    public static let NewSearchButtonLabel = MZLocalizedString("TodayWidget.NewSearchButtonLabelV1", tableName: "Today", value: "Search in OceanHero", comment: "Open New Tab button label")
    ...
    public static let FirefoxShortcutGalleryDescription = MZLocalizedString("TodayWidget.FirefoxShortcutGalleryDescription", tableName: "Today", value: "Add OceanHero shortcuts to your Home screen.", comment: "Description for medium size widget to add OceanHero Shortcut to home screen")
    
    // Quick Action - Small Size Widget
    public static let SearchInFirefoxTitle = MZLocalizedString("TodayWidget.SearchInFirefoxTitle", tableName: "Today", value: "Search in OceanHero", comment: "Title for small size widget which allows users to search in OceanHero. Do not translate the word OceanHero.")
    ...
    public static let QuickActionDescription = MZLocalizedString("TodayWidget.QuickActionDescription", tableName: "Today", value: "Select a OceanHero shortcut to add to your Home screen.", comment: "Quick action description when widget enters edit mode")
    ...
    public static let QuickActionGalleryDescription = MZLocalizedString("TodayWidget.QuickActionGalleryDescription", tableName: "Today", value: "Add a OceanHero shortcut to your Home screen. After adding the widget, touch and hold to edit it and select a different shortcut.", comment: "Description for small size widget to add it to home screen")
    
    // Top Sites - Medium Size Widget
    public static let TopSitesSubLabel = MZLocalizedString("TodayWidget.TopSitesSubLabel", tableName: "Today", value: "OceanHero - Top Sites", comment: "Sub label for Top Sites widget")
    public static let TopSitesSubLabel2 = MZLocalizedString("TodayWidget.TopSitesSubLabel2", tableName: "Today", value: "OceanHero - Website Shortcuts", comment: "Sub label for Shortcuts widget")
    
    // Top Sites - Medium Size - Gallery View
    public static let TopSitesGalleryTitle = MZLocalizedString("TodayWidget.TopSitesGalleryTitle", tableName: "Today", value: "Top Sites", comment: "Title for top sites widget to add OceanHero top sites shotcuts to home screen")
    public static let TopSitesGalleryTitleV2 = MZLocalizedString("TodayWidget.TopSitesGalleryTitleV2", tableName: "Today", value: "Website Shortcuts", comment: "Title for top sites widget to add OceanHero top sites shotcuts to home screen")
    public static let TopSitesGalleryDescription = MZLocalizedString("TodayWidget.TopSitesGalleryDescription", tableName: "Today", value: "Add shortcuts to frequently and recently visited sites.", comment: "Description for top sites widget to add OceanHero top sites shotcuts to home screen")

    // Quick View Open Tabs - Medium Size Widget
    public static let QuickViewOpenTabsSubLabel = MZLocalizedString("TodayWidget.QuickViewOpenTabsSubLabel", tableName: "Today", value: "OceanHero - Open Tabs", comment: "Sub label for Top Sites widget")
    ...
    public static let OpenFirefoxLabel = MZLocalizedString("TodayWidget.OpenFirefoxLabel", tableName: "Today", value: "Open OceanHero", comment: "Open OceanHero when there are no tabs opened in tab tray i.e. Empty State")
    ...
    public static let PocketWidgetSubLabel = MZLocalizedString("TodayWidget.PocketWidgetSubLabel", tableName: "Today", value: "OceanHero - Recommended by Pocket", comment: "Sub label for medium size OceanHero Pocket stories widge widget. Pocket is the name of another app.")
    public static let ViewMoreDots = MZLocalizedString("TodayWidget.ViewMoreDots", tableName: "Today", value: "View More…", comment: "View More… for OceanHero Pocket stories widget where we don't know how many articles are available.")

    // Pocket - Large - Medium Size - Gallery View
    public static let PocketWidgetGalleryTitle = MZLocalizedString("TodayWidget.PocketWidgetTitle", tableName: "Today", value: "Recommended by Pocket", comment: "Title for OceanHero Pocket stories widget in Gallery View where user can add it to home screen. Pocket is the name of another app.")
    public static let PocketWidgetGalleryDescription = MZLocalizedString("TodayWidget.PocketWidgetGalleryDescription", tableName: "Today", value: "Discover fascinating and thought-provoking stories from across the web, curated by Pocket.", comment: "Description for OceanHero Pocket stories widget in Gallery View where user can add it to home screen. Pocket is the name of another app.")
}

// MARK: - Default Browser
extension String {
    public static let DefaultBrowserCardTitle = MZLocalizedString("DefaultBrowserCard.Title", tableName: "Default Browser", value: "Switch Your Default Browser", comment: "Title for small card shown that allows user to switch their default browser to OceanHero.")
    public static let DefaultBrowserCardDescription = MZLocalizedString("DefaultBrowserCard.Description", tableName: "Default Browser", value: "Set links from websites, emails, and Messages to open automatically in OceanHero.", comment: "Description for small card shown that allows user to switch their default browser to OceanHero.")
    ...
    public static let DefaultBrowserMenuItem = MZLocalizedString("Settings.DefaultBrowserMenuItem", tableName: "Default Browser", value: "Set as Default Browser", comment: "Menu option for setting OceanHero as default browser.")
    public static let DefaultBrowserOnboardingScreenshot = MZLocalizedString("DefaultBrowserOnboarding.Screenshot", tableName: "Default Browser", value: "Default Browser App", comment: "Text for the screenshot of the iOS system settings page for OceanHero.")
    ...
    public static let DefaultBrowserOnboardingDescriptionStep3 = MZLocalizedString("DefaultBrowserOnboarding.Description3", tableName: "Default Browser", value: "3. Select OceanHero", comment: "Description for default browser onboarding card.")
    public static let DefaultBrowserOnboardingButton = MZLocalizedString("DefaultBrowserOnboarding.Button", tableName: "Default Browser", value: "Go to Settings", comment: "Button string to open settings that allows user to switch their default browser to OceanHero.")
}
...
extension String {
    public static let CrashOptInAlertTitle = MZLocalizedString("Oops! OceanHero crashed", comment: "Title for prompt displayed to user after the app crashes")
...
extension String {
    ...
    public static let RestoreTabsAlertMessage = MZLocalizedString("Looks like OceanHero crashed previously. Would you like to restore your tabs?", comment: "Restore Tabs Prompt Description")
...
extension String {
    ...
    public static let TabTrayPrivateBrowsingDescription =  MZLocalizedString("OceanHero won’t remember any of your history or cookies, but new bookmarks will be saved.", tableName: "PrivateBrowsing", comment: "Description text displayed when there are no open tabs while in private mode")
...
extension String {
    ...
    public static let RemoteTabErrorNoTabs = MZLocalizedString("You don’t have any tabs open in OceanHero on your other devices.", comment: "Error message in the remote tabs panel")
...
extension String {
    public static let ReaderModeHandlerLoadingContent = MZLocalizedString("Loading content…", comment: "Message displayed when the reader mode page is loading. This message will appear only when sharing to OceanHero reader mode from another app.")
    public static let ReaderModeHandlerPageCantDisplay = MZLocalizedString("The page could not be displayed in Reader View.", comment: "Message displayed when the reader mode page could not be loaded. This message will appear only when sharing to OceanHero reader mode from another app.")
    public static let ReaderModeHandlerLoadOriginalPage = MZLocalizedString("Load original page", comment: "Link for going to the non-reader page when the reader view could not be loaded. This message will appear only when sharing to OceanHero reader mode from another app.")
...
extension String {
    ...
    public static let PrivateBrowsingDescription = MZLocalizedString("OceanHero won’t remember any of your history or cookies, but new bookmarks will be saved.", tableName: "PrivateBrowsing", comment: "Description text displayed when there are no open tabs while in private mode")
}
...
extension String {
    ...
    public static let AppSettingsPrivacyPolicy = MZLocalizedString("Privacy Policy", comment: "Show OceanHero Browser Privacy Policy page from the Privacy section in the settings. See https://www.mozilla.org/privacy/OceanHero/")
...
extension String {
    ...
    public static let MenuHelperSearchWithFirefox = MZLocalizedString("UIMenuItem.SearchWithFirefox", value: "Search with OceanHero", comment: "Search in New Tab Text selection menu item")
}
...
extension String {
    ...
    public static let LoginsListNoLoginsFoundDescription = MZLocalizedString("LoginsList.NoLoginsFound.Description", value: "Saved logins will show up here. If you saved your logins to OceanHero on a different device, sign in to your OceanHero Account.", comment: "Label shown when there are no logins to list")
}

...
class BrowserViewController: UIViewController {
    ...
    var firefoxHomeBackgroundView: UIView?
    ...
    fileprivate var homePanelIsInline = true
   ...
   @objc  func appWillResignActiveNotification() {
        ...
        firefoxHomeBackgroundView?.alpha = 0
    ...
    @objc func appDidBecomeActiveNotification() {
        ...
        UIView.animate(withDuration: 0.2, delay: 0, options: UIView.AnimationOptions(), animations: {
            ...
            self.firefoxHomeBackgroundView?.alpha = 1
    ...
    override func updateViewConstraints() {
      ...
      firefoxHomeBackgroundView?.snp.remakeConstraints { make in
    ...
    func showFirefoxHome(inline: Bool) {
        ...
        if self.firefoxHomeViewController == nil {
            ...
            firefoxHomeViewController.delegate = self
      ...
      if self.firefoxHomeBackgroundView == nil {
        let firefoxHomeBackgroundView = UIView()
        self.firefoxHomeBackgroundView = firefoxHomeBackgroundView
        view.insertSubview(firefoxHomeBackgroundView, belowSubview: statusBarOverlay)
        
        let image = traitCollection.userInterfaceStyle == .dark ? #imageLiteral(resourceName: "OHbackgroundDarkMode") : #imageLiteral(resourceName: "OHbackgroundLightMode")
        let imageView = UIImageView(image: image)
        imageView.contentMode = .scaleAspectFill
        firefoxHomeBackgroundView.addSubview(imageView)

        imageView.snp.remakeConstraints { make in
          guard let view = self.firefoxHomeBackgroundView else {
            return
          }
      ...
      if self.firefoxHomeViewController?.view.alpha == 0 {
        firefoxHomeViewController?.refreshBottle()
      }
    ...
    fileprivate func hideFirefoxHome() {
        ...
        let firefoxHomeBackgroundView = self.firefoxHomeBackgroundView

        self.firefoxHomeViewController = nil
        self.firefoxHomeBackgroundView = nil
    ...
    func showSearchController() {
        ...
        firefoxHomeBackgroundView?.isHidden = true
    ...
    func hideSearchController() {
        if let searchController = self.searchController {
            ...
            firefoxHomeBackgroundView?.isHidden = false
        }
    }
...
extension BrowserViewController: FirefoxHomeDelegate {

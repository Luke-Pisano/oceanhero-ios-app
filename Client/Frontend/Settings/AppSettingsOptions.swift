...
class SendFeedbackSetting: Setting {
    ...
    override var url: URL? {
        return URL(string: "https://docs.google.com/forms/d/e/1FAIpQLSe8nH6DUfKAfKBqZoGL0m5qPH2za8AUnp3I4JM36kwkTqd8ww/viewform?usp=sf_link")
    }
...
class OpenSupportPageSetting: Setting {
    ...
    override func onClick(_ navigationController: UINavigationController?) {
        navigationController?.dismiss(animated: true) {
            if let url = URL(string: "https://oceanhero.zendesk.com/hc/en-us/categories/4407467571602-iOS-app") {
...
class PrivacyPolicySetting: Setting {
    ...
    override var url: URL? {
        return URL(string: "https://about.oceanhero.today/privacy-policy")
    }
